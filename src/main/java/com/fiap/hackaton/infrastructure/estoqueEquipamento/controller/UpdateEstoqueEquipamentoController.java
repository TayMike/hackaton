...
public class UpdateEstoqueEquipamentoController {
    ...
    public EstoqueEquipamentoPublicData updateEstoqueEquipamento(@PathVariable UUID id, @RequestBody EstoqueEquipamentoUpdateData dados) throws EstoqueEquipamentoNotFoundException {
