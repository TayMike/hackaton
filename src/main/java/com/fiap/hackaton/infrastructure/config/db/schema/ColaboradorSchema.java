...
public class ColaboradorSchema extends AbstractEntitySchema<UUID> {
    ...
    public Colaborador toColaborador() {
        Colaborador colaborador = new Colaborador (
                ...
                this.getCep(),
                this.getNumeroCasa(),
                this.getHospital().toHospital(),
                this.getSetor(),
                this.getAtivo()
        );

        colaborador.setId(this.getId()); // transform the schema id (generated by database) to entity customer id
