...
public class EntregaInsumoDatabaseInsumoGateway implements EntregaInsumoGateway {

    private final EntregaInsumoRepository entregaInsumoRepository;

    public EntregaInsumoDatabaseInsumoGateway(EntregaInsumoRepository entregaInsumoRepository) {
